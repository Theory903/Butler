...
class LifecycleManager:
    ...
    async def stage_version(
        self, package_id: str, version: str, archive_bytes: bytes, manifest: SkillManifest
    ) -> Path:
        """
        ...
        logger.info(
            "package_staged", package_id=package_id, version=version, path=str(pkg_release_dir)
        )
    ...
    def get_active_path(self, package_id: str) -> Path | None:
