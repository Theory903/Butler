...
class AdoptionTier(str, enum.Enum):
...
class ChannelConfig(BaseModel):
    ...
    circuit_breaker_recovery_timeout: int = Field(gt=0, default=30, description="Seconds in half-open")
...
class CapabilityMatrix:
    ...
    def get_channels_for_capability(cls, capability: Capability) -> List[Channel]:
        return [
            channel for channel, caps in cls._capabilities.items()
...
class ChannelAdapter(ABC):
    ...
    @abstractmethod
    async def send_message(self, recipient_id: str, message: Dict[str, Any], idempotency_key: Optional[UUID] = None) -> Dict[str, Any]:
...
class ChannelRegistry:
    ...
    def get(self, channel: Channel) -> Optional[ChannelAdapter]:
        """Get adapter for specified channel."""
        return self._adapters.get(channel)

    def get_config(self, channel: Channel) -> Optional[ChannelConfig]:
    ...
    def get_enabled_channels(self) -> List[Channel]:
        ...
        return [
            channel for channel, config in self._configs.items()
            if config.enabled
        ]
        ...
        with tracer.start_as_current_span("channel_registry.load_hermes_adapters"):
            for config in self._configs.values():
                ...
                try:
                    ...
                    logger.debug(f"No Hermes adapter found for {config.channel}, falling back to default/stub.")
...
def _initialize_default_capabilities() -> None:
    ...
    # P0 Channels
    CapabilityMatrix.register_capabilities(Channel.WHATSAPP, [
        Capability.SEND_MESSAGE, Capability.RECEIVE_MESSAGE,
        Capability.SEND_ATTACHMENT, Capability.RECEIVE_ATTACHMENT,
        Capability.TYPING_INDICATOR, Capability.DELIVERY_RECEIPT,
        Capability.READ_RECEIPT, Capability.INTERACTIVE_BUTTONS,
    ])

    CapabilityMatrix.register_capabilities(Channel.TELEGRAM, [
        Capability.SEND_MESSAGE, Capability.RECEIVE_MESSAGE,
        Capability.EDIT_MESSAGE, Capability.DELETE_MESSAGE,
        Capability.SEND_ATTACHMENT, Capability.RECEIVE_ATTACHMENT,
        Capability.TYPING_INDICATOR, Capability.MESSAGE_REACTION,
        Capability.THREADS, Capability.BOT_COMMANDS,
        Capability.INTERACTIVE_BUTTONS, Capability.MODALS,
    ])

    CapabilityMatrix.register_capabilities(Channel.SLACK, [
        Capability.SEND_MESSAGE, Capability.RECEIVE_MESSAGE,
        Capability.EDIT_MESSAGE, Capability.DELETE_MESSAGE,
        Capability.SEND_ATTACHMENT, Capability.RECEIVE_ATTACHMENT,
        Capability.TYPING_INDICATOR, Capability.MESSAGE_REACTION,
    ...
    CapabilityMatrix.register_capabilities(Channel.DISCORD, [
        Capability.SEND_MESSAGE, Capability.RECEIVE_MESSAGE,
        Capability.EDIT_MESSAGE, Capability.DELETE_MESSAGE,
        Capability.SEND_ATTACHMENT, Capability.RECEIVE_ATTACHMENT,
        Capability.TYPING_INDICATOR, Capability.MESSAGE_REACTION,
        Capability.THREADS, Capability.BOT_COMMANDS,
        Capability.INTERACTIVE_BUTTONS, Capability.USER_PRESENCE,
    ])

    # P1 Channels
    CapabilityMatrix.register_capabilities(Channel.SIGNAL, [
        Capability.SEND_MESSAGE, Capability.RECEIVE_MESSAGE,
        Capability.SEND_ATTACHMENT, Capability.RECEIVE_ATTACHMENT,
        Capability.TYPING_INDICATOR, Capability.DELIVERY_RECEIPT,
    ...
    CapabilityMatrix.register_capabilities(Channel.MATRIX, [
        Capability.SEND_MESSAGE, Capability.RECEIVE_MESSAGE,
        Capability.EDIT_MESSAGE, Capability.DELETE_MESSAGE,
        Capability.SEND_ATTACHMENT, Capability.RECEIVE_ATTACHMENT,
        Capability.TYPING_INDICATOR, Capability.MESSAGE_REACTION,
        Capability.THREADS, Capability.DELIVERY_RECEIPT,
        Capability.READ_RECEIPT,
    ])

    # P2 Channels
    CapabilityMatrix.register_capabilities(Channel.TEAMS, [
        Capability.SEND_MESSAGE, Capability.RECEIVE_MESSAGE,
        Capability.SEND_ATTACHMENT, Capability.RECEIVE_ATTACHMENT,
        Capability.TYPING_INDICATOR, Capability.BOT_COMMANDS,
        Capability.INTERACTIVE_BUTTONS,
    ])

    # Utility Channels
    CapabilityMatrix.register_capabilities(Channel.EMAIL, [
        Capability.SEND_MESSAGE, Capability.RECEIVE_MESSAGE,
        Capability.SEND_ATTACHMENT, Capability.RECEIVE_ATTACHMENT,
    ])

    CapabilityMatrix.register_capabilities(Channel.SMS, [
        Capability.SEND_MESSAGE, Capability.RECEIVE_MESSAGE,
        Capability.DELIVERY_RECEIPT,
    ])

    CapabilityMatrix.register_capabilities(Channel.PUSH, [
        Capability.SEND_MESSAGE, Capability.INTERACTIVE_BUTTONS,
    ])

    CapabilityMatrix.register_capabilities(Channel.WEBHOOK, [
        Capability.SEND_MESSAGE, Capability.RECEIVE_MESSAGE,
        Capability.SEND_ATTACHMENT, Capability.RECEIVE_ATTACHMENT,
    ])

    CapabilityMatrix.register_capabilities(Channel.IN_APP, [
        Capability.SEND_MESSAGE, Capability.RECEIVE_MESSAGE,
        Capability.EDIT_MESSAGE, Capability.DELETE_MESSAGE,
        Capability.SEND_ATTACHMENT, Capability.RECEIVE_ATTACHMENT,
        Capability.TYPING_INDICATOR, Capability.MESSAGE_REACTION,
