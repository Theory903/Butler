...
from .models import AudioModelProxy, TranscribeResult
...
class DualSTTStrategy:
    ...
    async def fast_pass(self, audio_data: bytes, language: str | None) -> TranscribeResult:
        """
    ...
    async def accurate_pass(self, audio_data: bytes, language: str | None) -> TranscribeResult:
        """
