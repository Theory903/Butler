...
class ConnectionManager:
    ...
    def __init__(self, redis: Redis, presence: PresenceService, syncer: GlobalStateSyncer | None = None):
        ...
        self._listener: Optional["RealtimePubSubListener"] = None
    ...
    async def connect(self, websocket: WebSocket, account_id: str, session_id: str):
        ...
        async with self._redis.pipeline(transaction=True) as pipe:
            pipe.hset(f"presence:{account_id}", mapping={
                "status": "connected",
