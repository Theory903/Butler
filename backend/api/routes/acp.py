...
async def list_all_requests(account_id: str = "demo", db: AsyncSession = Depends(get_db)) -> dict:
    query = (
        select(ApprovalRequest)
        .where(ApprovalRequest.account_id == uuid.UUID(account_id))
...
async def get_request(
    request_id: str, account_id: str = "demo", db: AsyncSession = Depends(get_db)
) -> dict:
