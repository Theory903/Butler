...
from domain.security.models import PolicyInput, ToolGateRequest, ActorContext
...
async def authorize(req: AuthorizeRequest, svc: SecurityService = Depends(get_security)):
    ...
    return {"allowed": decision.allow, "reason": decision.reason, "obligations": decision.obligations}
