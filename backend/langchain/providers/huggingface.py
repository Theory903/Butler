...
class HuggingFaceProvider(BaseProvider):
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            if self._config.provider_type == ProviderType.CHAT and self._config.extra_params.get("local"):
            ...
            logger.warning("langchain_huggingface_not_installed: Install with: pip install langchain-huggingface")
    ...
    async def call(self, **kwargs: Any) -> Any:
        ...
        if test:
            ...
            elif self._embedding_client:
                return await self._embedding_client.aembed_query("test")
            elif self._pipeline_client:
