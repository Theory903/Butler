...
class ProviderRegistry:
    ...
    def get(self, provider_name: str, provider_type: ProviderType) -> Optional[BaseProvider]:
    ...
    async def shutdown_all(self) -> None:
        ...
        for provider_id, provider in self._providers.items():
            try:
                ...
                logger.error("provider_shutdown_failed", extra={"provider_id": provider_id, "error": str(e)})
