...
class DeviceRegistry(Base):
    ...
    )  # pending, trusted, compromised, unpaired
    online_state: Mapped[str] = mapped_column(
    ...
    )  # list of string IDs matching Butler Capability Enums
