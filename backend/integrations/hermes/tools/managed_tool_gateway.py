...
from .tool_backend_helpers import managed_nous_tools_enabled
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        auth_module = importlib.import_module("backend.integrations.hermes.hermes_cli.auth")
        resolve_nous_access_token = getattr(auth_module, "resolve_nous_access_token")
