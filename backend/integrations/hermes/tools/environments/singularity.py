...
def _get_scratch_dir() -> Path:
    ...
    if scratch.exists() and os.access(scratch, os.W_OK):
        user_scratch = scratch / os.getenv("USER", "hermes") / "butler-agent"
...
class SingularityEnvironment(BaseEnvironment):
    ...
    def _start_instance(self):
        ...
        try:
            from integrations.hermes.tools.credential_files import get_credential_file_mounts, get_skills_directory_mount
