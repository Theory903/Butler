...
from integrations.hermes.gateway.platforms.helpers import MessageDeduplicator
...
class SlackAdapter(BasePlatformAdapter):
    ...
    def _has_active_session_for_thread(
        ...
        try:
            from integrations.hermes.gateway.session import SessionSource, build_session_key
        ...
        async with httpx.AsyncClient(timeout=30.0, follow_redirects=True) as client:
            for attempt in range(3):
                try:
                    ...
                    if audio:
                        from integrations.hermes.gateway.platforms.base import cache_audio_from_bytes
                        return cache_audio_from_bytes(response.content, ext)
                    else:
                        from integrations.hermes.gateway.platforms.base import cache_image_from_bytes
