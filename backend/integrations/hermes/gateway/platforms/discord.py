...
# Butler Integration: Deferred / future capability
# Preserved as-is. Not active in current Butler MVP path.
...
from .helpers import MessageDeduplicator, ThreadParticipationTracker
from .base import (
    BasePlatformAdapter,
    MessageEvent,
    MessageType,
...
class DiscordAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            from integrations.hermes.gateway.platforms.base import resolve_proxy_url, proxy_kwargs_for_bot
    ...
    async def _process_voice_input(self, guild_id: int, user_id: int, pcm_data: bytes):
        ...
        from integrations.hermes.tools.voice_mode import is_whisper_hallucination
    ...
    async def send_image(
        ...
        try:
            ...
            from integrations.hermes.gateway.platforms.base import resolve_proxy_url, proxy_kwargs_for_aiohttp
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="stop", description="Stop the running Butler")
        ...
        @tree.command(name="update", description="Update Butler to the latest version")
    ...
    def _text_batch_key(self, event: MessageEvent) -> str:
        ...
        from integrations.hermes.gateway.session import build_session_key
