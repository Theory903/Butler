...
- GET  /v1/models                  — lists butler-agent as an available model
...
AnythingLLM, NextChat, ChatBox, etc.) can connect to butler-agent
...
from integrations.hermes.gateway.config import Platform, PlatformConfig
from integrations.hermes.gateway.platforms.base import (
    BasePlatformAdapter,
    SendResult,
...
class APIServerAdapter(BasePlatformAdapter):
    ...
    and routes them through butler-agent's AIAgent.
    """
    ...
    def _create_agent(
        ...
        from integrations.hermes.gateway.run import _resolve_runtime_agent_kwargs, _resolve_gateway_model, _load_gateway_config
        ...
        from integrations.hermes.gateway.run import GatewayRunner
    ...
    async def _handle_health(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response({"status": "ok", "platform": "butler-agent"})
    ...
    async def _handle_health_detailed(self, request: "web.Request") -> "web.Response":
        ...
        """
        from integrations.hermes.gateway.status import read_runtime_status

        runtime = read_runtime_status() or {}
        return web.json_response({
            "status": "ok",
            "platform": "butler-agent",
    ...
    async def _handle_models(self, request: "web.Request") -> "web.Response":
        """GET /v1/models — return butler-agent as an available model."""
