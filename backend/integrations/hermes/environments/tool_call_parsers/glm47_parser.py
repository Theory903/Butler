...
from integrations.hermes.environments.tool_call_parsers import ParseResult, register_parser
from integrations.hermes.environments.tool_call_parsers.glm45_parser import Glm45ToolCallParser
